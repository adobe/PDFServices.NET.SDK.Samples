...
/// <para/>
/// Note that extracting a PDF file results in a ZIP archive containing texta
/// <para/>
/// Refer to README.md for instructions on how to run the samples.
/// </summary>
namespace ExtractTextInfoWithCharBoundsFromPDF
{
    class Program
    {
        ...
        static void Main()
        {
            ...
            try
            {
                ...
                result.SaveAs(Directory.GetCurrentDirectory() + "/output/ExtractTextInfoWithCharBoundsFromPDF.zip");
            }
