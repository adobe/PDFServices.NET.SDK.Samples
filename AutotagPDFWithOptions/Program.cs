    ...
    class Program
    {
        ...
        static void Main()
        {
            ...
            try
            {
                ...
                autotagPDFOutput.GetTaggedPDF().SaveAs(Directory.GetCurrentDirectory() + CreateOutputFilePath(".pdf"));
                autotagPDFOutput.GetReport().SaveAs(Directory.GetCurrentDirectory() + CreateOutputFilePath(".xlsx"));
            }
        ...
        public static string CreateOutputFilePath(String extension)
        {
            String timeStamp = DateTime.Now.ToString("yyyy'-'MM'-'dd'T'HH'-'mm'-'ss");
            switch (extension)
            {
                case ".xlsx":
                    return "/output/autotag-report" + timeStamp + ".xlsx";
                case ".pdf":
                    return "/output/autotag-tagged" + timeStamp + ".pdf";
                default:
                    return "/output/autotag-tagged" + timeStamp + ".pdf";
            }
        }
